    ...
    <div className="px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2">
          ...
          <form onSubmit={deposit} className="rounded-2xl border border-white/10 bg-neutral-900/40 p-5">
            ...
            <div className="mt-4 flex flex-col gap-3 sm:flex-row">
              <input
                ...
                className="h-12 flex-1 rounded-xl border border-white/10 bg-neutral-900 px-4 text-white outline-none focus:border-white/30"
                placeholder="0.00"
                required
              />
              <button
                type="submit"
                disabled={loading}
                className="h-12 rounded-xl bg-white px-5 text-sm font-semibold text-neutral-900 transition-colors hover:bg-neutral-200 active:scale-[0.98] disabled:opacity-60"
              >
        ...
        <div className="mt-8 rounded-2xl border border-white/10 bg-neutral-900/40 p-5">
